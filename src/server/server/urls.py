...
urlpatterns = patterns('',
    ...
    url(r'^api/redirect_to_login/$', RedirectView.as_view(url='http://127.0.0.1:9000'), name='password_reset_complete'),
    ...
    url(r'^market/(?P<market_id>[0-9-]+)/$', views.RWDMarketView.as_view(), name='market-rwd'),    
    url(r'^markets/add/$',views.AddMarketView.as_view(), name='market-add'),    
    url(r'^markets/delete/$',views.DeleteMarketView.as_view(), name='market-remove'),       
    ...
    url(r'^markets/photo/add/$',views.AddMarketPhotoView.as_view(), name='market-photo-add'),
